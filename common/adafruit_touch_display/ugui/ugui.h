...
UG_RESULT UG_WindowSetTitleTextFont(UG_WINDOW * wnd,
    const UG_FONT * font);
...
UG_RESULT UG_ButtonSetFont(UG_BUTTON * btn,
    const UG_FONT * font);
...
/* Checkbox functions */
UG_RESULT UG_CheckboxCreate(UG_CHECKBOX * btn, UG_WINDOW * wnd, UG_S16 xs, UG_S16 ys, UG_S16 xe, UG_S16 ye);
...
UG_RESULT UG_CheckboxSetFont(UG_CHECKBOX * btn,
    const UG_FONT * font);
