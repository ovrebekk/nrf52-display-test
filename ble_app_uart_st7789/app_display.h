...
#define CBOX_X_LOCATION TXT_ID_0_X_LOCATION
#define CBOX_Y_LOCATION (BTN_ID_1_Y_LOCATION + BTN_ID_1_HEIGHT + INTERWIDGET_SPACE)
#define CBOX_WIDTH TXT_ID_0_WIDTH
#define CBOX_HEIGHT 20
